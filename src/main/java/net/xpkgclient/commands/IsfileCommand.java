...
/**
 * This command determines if a file is existent and file.
 */
final class IsfileCommand extends TwoVarCommand {
    ...
    public static void execute(String[] args, ExecutionContext context) throws XPkgException {
        updateValues(CommandName.ISFILE, args, context);

        if (!(secondArg instanceof XPkgFile fileVar))
            throw new XPkgTypeMismatchException(CommandName.ISFILE, "second", VarType.FILE, secondArg.getVarType());
